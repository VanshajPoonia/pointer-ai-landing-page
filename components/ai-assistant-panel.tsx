  ...
  return (
    <div className="w-full max-w-[400px] min-w-[280px] h-full bg-[#252526] border-l border-[#191919] flex flex-col shrink-0 overflow-hidden">
      {/* Header */}
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center text-center px-2 py-6">
              ...
              <p className="text-[#808080] text-sm mb-4">
                I can read and modify your code. Ask me to generate code, fix bugs, explain concepts, or make improvements.
              </p>
        ...
        {/* Input */}
        <form onSubmit={handleSubmit} className="p-3 border-t border-[#191919] shrink-0">
          <div className="flex items-center gap-2">
            <input
              type="text"
              value={input}
